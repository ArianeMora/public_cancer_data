...
input_folder = '../../input_data/LungAdenocarcinoma_PDC000153'
disease_space = 'Lung Adenocarcinoma'
sample_df = pd.read_csv(os.path.join(input_folder, f'PDC_study_biospecimen_07172023_114641.tsv'), sep='\t')
df = pd.read_csv(os.path.join(input_folder, f'CPTAC3_Lung_Adeno_Carcinoma_Proteome.tmt10.tsv'), sep='\t')
