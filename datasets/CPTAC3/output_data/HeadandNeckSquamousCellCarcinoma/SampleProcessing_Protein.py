...
input_folder = '../../input_data/HeadandNeckSquamousCellCarcinoma_PDC000221'
disease_space = 'Head and Neck Squamous Cell Carcinoma'
sample_df = pd.read_csv(os.path.join(input_folder, f'PDC_study_biospecimen_07172023_114256.tsv'), sep='\t')
df = pd.read_csv(os.path.join(input_folder, f'CPTAC3_Head_and_Neck_Carcinoma_Proteome.tmt11.tsv'), sep='\t')
